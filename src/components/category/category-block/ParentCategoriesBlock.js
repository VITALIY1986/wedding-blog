...
const ParentCategoriesBlock = ( props ) => {
	...
	const { productCategorArkanaHome, productCategorArkanaProf, productCategories,productChantarelleHome ,productChantarelleProf,productNorelHome,productNorelProf} = props || {};
