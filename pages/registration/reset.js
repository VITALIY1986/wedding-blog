...
import Login from "../../src/components/login/reset";
import Logi from "../../src/components/login/reset2";
function App() {
	...
	<div class="relative h-screen overflow-x-hidden bg-blue ">
		...
		<Link href="/set-password/?key=NsiUzAVJLPlXKJ9MbCBY&login=4PROFADMIN">
            <a>ddddddddddddddd</a>
          </Link>		
	<Login></Login>
	<Logi></Logi>
