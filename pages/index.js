...
export default function Home (props) {
	...
	const { products, productCategories, heroCarousel, posts } = props || {};
	...
	return (
			<Layout>
				...
				<div className="product-categories-container container mx-auto my-32 px-4 xl:px-0">
					...
					<h2 className="products-main-title main-title mb-5 text-xl uppercase"><span className="main-title-inner">news</span></h2>
